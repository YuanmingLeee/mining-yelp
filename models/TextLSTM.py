...
class TextLSTM(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.lstm = nn.LSTM(self.cfg.EMBEDDING_LENGTH, self.hidden_size, bidirectional=True)
    ...
    def forward(self, x):
        ...
        h_0 = Variable(torch.zeros(2, bs, self.hidden_size)).cuda()
        c_0 = Variable(torch.zeros(2, bs, self.hidden_size)).cuda()
