...
def review_preprocessing(merged_review_csv_dir, glove_embedding_dir, output_dir, train_ratio, keep_ratio,
                         review_length_max, review_length_min, seq_length, embedding_length):
    # split data
